...
public interface IProviderService {
	...
	public edu.stevens.cs548.clinic.service.dto.TreatmentDto getTreatment(UUID providerId, UUID treatmentId) throws ProviderNotFoundExn, TreatmentNotFoundExn, ProviderServiceExn;
