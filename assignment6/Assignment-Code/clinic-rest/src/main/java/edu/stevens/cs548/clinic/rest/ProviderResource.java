...
//			URI patientUri = getPatientUri(uriInfo, treatment.getPatientId());
//			responseBuilder.link(patientUri, "patient");
//			URI providerUri = getProviderUri(uriInfo, treatment.getProviderId());
//			responseBuilder.link(providerUri, "provider");
